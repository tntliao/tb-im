	...
	<view id="moments" class="page">
		...
		<view class="moments__post" v-for="(post,index) in posts" :key="index" :id="'post-'+index">
			<view class="post-left">
				<image class="post_header" :src="getNewAvatar(staticPhoto , post.header_image)"
			...
			<view class="post_right">
				...
				<view class="toolbar">
					...
					<view style="font-size: 20upx;margin-left: 150upx;" @tap="del(index)" v-if="my_data.id==post.uid">删除
					</view>
